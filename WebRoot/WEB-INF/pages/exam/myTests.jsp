    ...
    <div class="content">
    	<div class="container">
    		...
    		<div class="row">
    			...
    			<div class="span7">
    			<br>
    				<c:forEach items="${testPage.list}" var="test" varStatus="status">
	    			<!-- Accordian -->
	    			<div class="accordion" id="accordion2">
	    				<div class="accordion-group">
	    		    		<div class="accordion-heading">
	    			    		<a class="accordion-toggle"  href="/exam/showTest/${test.get('replyId')}">
	    			    			<span>${status.count} . </span> ${test.get('title')}&nbsp;<span style="color:red">${test.get('score')}分</span><span class="timeago pull-right" style="color:green" title="${test.get('endTime')}"></span>
	    			    		</a>
	    		    		</div>
	    				</div>
		    		...
		    		<form name="queryform" id="queryform" action="/exam/myTests" method="post">
	...
	//隐藏显示插件
	 ...
	 //分页插件
		$(document).ready(function(){
			window.simpleTable = new SimpleTable("queryform",${testPage.pageNumber},${testPage.pageSize},'${sortColumn}');
		});
	</script>    	
  </body>
</html>
